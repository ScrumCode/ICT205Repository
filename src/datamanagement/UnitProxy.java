package datamanagement;
		public class UnitProxy implements IUnit 
		{
			...
			UnitManager   um;//unit manager object definition

		public UnitProxy( String unitCode, String unitName ) 
		{
			this.UC = unitCode;
			this.un = unitName;
			um = UnitManager.UM(); //calling function of Class UnitManager UM() and assigning value it return to um
		}
		// under mentioned all the functions are getters and setters
		public String getUnitCode() 
		{ 
			return this.UC;//unit code getter
		}
